...
// 브라우저가 HTML 문서에 모든 요소들을 생성하고 난후, 이벤트 리스너 함수를 실행.
document.addEventListener('DOMContentLoaded', function() {
    ...
    // 찾은 HTML 요소에 이벤트 'click' 이벤트 리스너를 등록:
    ...
    // element:puedo_selector: (예) div:hover, tr:nth-child
    ...
    const btn4 = document.querySelector('#btn4'); // 메서드 이름에 Id, Class, 태그 등 이름을 명시하지 않아서 #을 붙혀씀.
