 ...
 */
 ...
 // 모든 책임은 함수를 호출하는 쪽에 있음.
 result = add('안녕하세요', 'Hello');
 console.log(result);
 
 // 자바스크립트 함수는 파라미터 개수를 검사하지 않음.
result = add(10, 20, 30); // 함수 선언의 파라미터 개수보다 더 많은 argument를 전달.
console.log('result = ', result);

result = add(1); // 함수 선언의 파라미터 개수보다 적은 argument를 전달.
...
const plus2 = add(); // 함수를 호출하고 함수의 리턴값을 저장하는 것.
